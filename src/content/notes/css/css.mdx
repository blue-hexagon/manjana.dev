...
subtitle: "Precedence, specificity, layout, and rendering behavior"
date: 2026-04-13
slug: css-fundamentals
description: "A structured reference of CSS fundamentals including specificity, inheritance, selectors, layout systems, and rendering behavior."
...
<CodeBlock language="css" blockId="css-inheritance" showLineNumbers="true">
{`
body {
  font-size: 22px;
}
...
<CodeBlock language="css" blockId="css-selectors" showLineNumbers="true">
{`
p span {
  color: blue;
...
<CodeBlock language="css" blockId="css-colors" showLineNumbers="true">
{`
...
<CodeBlock language="css" blockId="css-remove-decoration" showLineNumbers="true">
{`
ol {
...
<CodeBlock language="css" blockId="css-modify-decoration" showLineNumbers="true">
{`
::marker {
  color: red;
  font-family: fantasy;
...
<CodeBlock language="css" blockId="css-pseudo-class" showLineNumbers="true">
{`
a:visited {
  ...
}
...
<CodeBlock language="html" blockId="css-columns-html" showLineNumbers="true">
{`
...
<CodeBlock language="css" blockId="css-columns-css" showLineNumbers="true">
{`
.columns {
  column-count: 4;
