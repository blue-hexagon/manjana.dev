...
<EncodingBoundary
    ...
    scenarios={[
        ...
        },
        {
            ...
            description:
                "Logs are emitted in UTF-8 but decoded as Latin-1 downstream. Systems remain operational, but metrics and forensic timelines become unreliable.",
        },
        {
        ...
        },
        {
            ...
            source: "Auth issuer",
            sourceEncoding: "UTF-8",
            sourceText: "header.payload",
            bytes: "2E E2 80 8B",
            target: "API verifier",
            targetEncoding: "ASCII",
            targetText: "header.payload",
            description:
                "A zero-width Unicode character survives signing but is stripped during verification. Tokens randomly fail validation, causing intermittent authentication outages.",
        },
        {
