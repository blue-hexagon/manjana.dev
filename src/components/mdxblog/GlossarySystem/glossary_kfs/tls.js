export const tlsGlossary = {
    ...
    Unicode: {
        ...
        explanation:
            "Defines characters abstractly without prescribing byte-level storage or visual appearance.",
        appearsIn: ["Programming languages", "Operating systems", "Databases", "Web"],
        whyItMatters:
            "Enables consistent representation of text across platforms, languages, and systems.",
        kind: "standard",
        domain: ["text-encoding"],
        tags: ["codepoints", "characters"],
    },
