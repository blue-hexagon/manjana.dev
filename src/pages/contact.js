...
import { Box, Typography, TextField, Button, Container, CircularProgress, Snackbar, Grid, Stack } from '@mui/material';
          ...
          <form onSubmit={handleSubmit}>
            <Grid container spacing={2}>
              ...
              <Grid item xs={12}>
                ...
                {attachment && <Typography variant="body2" sx={{ mt: 1 }}>Attachment: {attachment.name}</Typography>}
              </Grid>
            </Grid>
